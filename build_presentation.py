...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  /* Slides */
  .slide { height:100vh; padding:56px 4vw 16px; display:flex; flex-direction:column; justify-content:center; position:absolute; top:0; left:0; width:100%; overflow:hidden; opacity:0; pointer-events:none; transition:opacity .35s ease; }
  .slide.active { opacity:1; pointer-events:auto; z-index:1; }
  .slide:nth-child(even) { background:var(--navy2); }
  .slide-inner { width:100%; transform-origin:top center; }

  /* Title slide */
  .hero { text-align:center; }
  .hero .tag { display:inline-block; background:var(--gold-dim); color:var(--gold); padding:5px 16px; border-radius:20px; font-size:.72rem; font-weight:700; letter-spacing:.08em; text-transform:uppercase; margin-bottom:12px; }
  .hero h1 { font-size:clamp(1.8rem,4.5vw,3.2rem); font-weight:900; line-height:1.1; margin-bottom:10px; }
  .hero h1 span { color:var(--gold); }
  .hero .sub { font-size:1rem; color:var(--text2); max-width:700px; margin:0 auto 20px; }
  .hero .schools { display:flex; justify-content:center; gap:40px; flex-wrap:wrap; margin-top:16px; }
  ...
  .sec-hdr .num { font-size:.72rem; color:var(--gold); font-weight:700; letter-spacing:.1em; text-transform:uppercase; }
  .sec-hdr h2 { font-size:clamp(1.4rem,3vw,2rem); font-weight:800; margin-top:2px; }
  .sec-hdr p { color:var(--text2); max-width:640px; margin-top:4px; font-size:.9rem; }
  ...
  /* Card */
  .card { background:var(--card); border:1px solid rgba(255,255,255,.06); border-radius:var(--radius); padding:16px; transition:transform .2s, box-shadow .2s; }
  ...
  .cmp-tbl { width:100%; border-collapse:collapse; font-size:.8rem; margin-top:10px; }
  .cmp-tbl th { background:var(--card2); padding:7px 10px; text-align:left; font-size:.68rem; text-transform:uppercase; letter-spacing:.05em; color:var(--text3); font-weight:700; border-bottom:2px solid var(--gold-dim); }
  .cmp-tbl td { padding:7px 10px; border-bottom:1px solid rgba(255,255,255,.04); vertical-align:top; }
  ...
  .stat-box .big { font-size:2rem; font-weight:900; }
  ...
  /* Chart containers */
  .chart-wrap { position:relative; width:100%; max-width:700px; margin:10px auto; }
  .chart-wrap.wide { max-width:900px; }
  .chart-wrap canvas { width:100% !important; }

  /* Benefit list */
  .benefits { list-style:none; }
  .benefits li { padding:7px 0; border-bottom:1px solid rgba(255,255,255,.04); display:flex; gap:10px; align-items:flex-start; }
  .benefits li:last-child { border-bottom:none; }
  .benefits .icon { font-size:1.2rem; flex-shrink:0; margin-top:2px; }
  .benefits .txt h4 { font-size:.88rem; font-weight:700; }
  .benefits .txt p { font-size:.78rem; color:var(--text2); margin-top:1px; }
  ...
  .timeline .step h4 { font-weight:700; font-size:.88rem; }
  .timeline .step p { font-size:.78rem; color:var(--text2); margin-top:1px; }

  /* Footer */
  .foot { text-align:center; padding:16px; color:var(--text3); font-size:.72rem; border-top:1px solid rgba(255,255,255,.04); }
  ...
  @media (max-width:640px) {
    .slide { padding:52px 12px 12px; height:100vh; }
...
<section class="slide" id="s7">
  ...
  <div class="grid2">
    <div class="card" style="border-left:3px solid var(--gold)">
      <h3 style="margin-bottom:12px">Dr. Ann Podleski</h3>
      <div style="font-size:.78rem;color:var(--gold);font-weight:600;margin-bottom:8px">PROFESSOR OF MATHEMATICS &amp; DEPARTMENT CHAIR &middot; HARRIS-STOWE STATE UNIVERSITY</div>
      <ul class="benefits">
      ...
      <div style="font-size:.8rem;color:var(--text3);margin-top:8px">PodleskA@hssu.edu &middot; (314) 340-3565 &middot; HGA 317</div>
    </div>
    <div class="card" style="border-left:3px solid var(--accent)">
      <h3 style="margin-bottom:12px">Dr. Harvey R. Fields, Jr.</h3>
      <div style="font-size:.78rem;color:var(--accent);font-weight:600;margin-bottom:8px">FOUNDING DEAN, COLLEGE OF STEM &middot; HARRIS-STOWE STATE UNIVERSITY</div>
      <ul class="benefits">
  ...
  <div class="card" style="margin-top:20px;border:1px solid var(--gold-dim)">
    <h3 style="margin-bottom:16px;text-align:center">The CSMB &harr; HSSU Connection</h3>
    <div class="grid3">
      <div style="text-align:center;padding:12px">
        <div style="font-size:2rem;margin-bottom:4px">&#x1F9D1;&#x200D;&#x1F3EB;</div>
        <h4 style="color:var(--gold);margin-bottom:6px">Everett Stuckey</h4>
        <div style="font-size:.78rem;color:var(--text3);margin-bottom:8px">9th &amp; 10th Grade Counselor, CSMB</div>
        <p style="font-size:.85rem;color:var(--text2)">Has known Dr. Fields for <strong style="color:var(--gold)">29 years</strong>. Has worked closely with Dr. Fields on student recruitment, grant development, internship placement for SLPS students, and growing HSSU STEM opportunities across the district.</p>
      </div>
      <div style="text-align:center;padding:12px">
        <div style="font-size:2rem;margin-bottom:4px">&#x1F393;</div>
        <h4 style="color:var(--accent);margin-bottom:6px">Monica Nickolai</h4>
        <div style="font-size:.78rem;color:var(--text3);margin-bottom:8px">College Admissions Specialist, CSMB</div>
        <p style="font-size:.85rem;color:var(--text2)">Previously worked for Dr. Fields at <strong style="color:var(--accent)">Washington University</strong>, bringing firsthand knowledge of his leadership approach and deep familiarity with university partnership logistics.</p>
      </div>
      <div style="text-align:center;padding:12px">
        <div style="font-size:2rem;margin-bottom:4px">&#x1F517;</div>
        <h4 style="color:var(--ok);margin-bottom:6px">Why This Matters</h4>
        <div style="font-size:.78rem;color:var(--text3);margin-bottom:8px">Trusted Relationships = Fast Execution</div>
        <p style="font-size:.85rem;color:var(--text2)">This isn't a cold partnership. Decades of personal and professional trust between CSMB staff and HSSU leadership means <strong style="color:var(--ok)">fewer barriers, faster decisions, and genuine investment</strong> in our students' success.</p>
      </div>
    </div>
  </div>
</section>
...
// --- Auto-fit: scale each slide's content to fit viewport ---
!function(){
  function fitAll(){
    document.querySelectorAll('.slide').forEach(s=>{
      let inner=s.querySelector('.slide-inner');
      if(!inner){
  ...
  window.addEventListener('resize',()=>{clearTimeout(window._fitT);window._fitT=setTimeout(fitAll,200);});
}();
</script>
</body>
</html>"""
