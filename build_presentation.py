...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  /* Slides */
  .slide { height:100vh; padding:56px 4vw 16px; display:flex; flex-direction:column; justify-content:center; position:relative; overflow:hidden; }
