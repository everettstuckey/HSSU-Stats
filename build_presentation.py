...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  /* Slide nav buttons */
  .slide-nav { position:fixed; bottom:28px; right:28px; z-index:101; display:flex; gap:10px; }
  .slide-nav button { width:44px; height:44px; border-radius:50%; border:2px solid var(--gold-dim); background:rgba(10,22,40,.85); backdrop-filter:blur(8px); color:var(--gold); font-size:1.1rem; cursor:pointer; display:flex; align-items:center; justify-content:center; transition:all .2s; }
  ...
  .slide-nav .counter { align-self:center; font-size:.75rem; color:var(--text3); font-weight:600; min-width:40px; text-align:center; }

  /* Responsive */
  @media (max-width:640px) {
    .slide { padding:70px 16px 30px; }
    .grid2, .grid3 { grid-template-columns:1fr; }
    .slide-nav { bottom:16px; right:16px; }
    .slide-nav button { width:38px; height:38px; font-size:.95rem; }
  }
</style>
</head>
<body>
